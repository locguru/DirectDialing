...
//    accessNumberObj = [[AccessNumber alloc] initWithNibName:@"AccessNumber" bundle:[NSBundle mainBundle]];
//    [accessNumberObj setDelegate:self];

}

- (void) processSuccessful {
    
    NSLog(@"NEW PRODUCT IS  and NEW BRAND ");
}
